...
let slider_review = new Swiper('.review__columns', {
	effect: 'coverflow',
	// autoplay: {
	// 	delay: 1000,
...
let slider_about = new Swiper('.about__columns', {
	effect: 'coverflow',
	// autoplay: {
	// 	delay: 1000,
	// 	disableOnInteraction: true,
...
document.querySelector('#s-block__1').style.setProperty('--animate-duration', '.5s');
document.querySelector('#s-block__2').style.setProperty('--animate-duration', '.75s');
document.querySelector('#s-block__3').style.setProperty('--animate-duration', '.95s');
document.querySelector('#s-block__4').style.setProperty('--animate-duration', '1.15s');
